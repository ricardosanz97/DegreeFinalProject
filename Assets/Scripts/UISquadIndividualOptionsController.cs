...
public class UISquadIndividualOptionsController : GenericPanelController
{
    ...
    public static UISquadIndividualOptionsController Create(Action callbackButtonFollowPlayer, Action callbackButtonBreakFormation, Action callbackButtonChangePosition)
    {
